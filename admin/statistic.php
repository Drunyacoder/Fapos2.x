...
<table width="100%">
	<tr>
	<td><a href="statistic.php?date=<?php echo $date - 168000 ?>"><?php echo '&laquo; ' . date("Y-m-d", $date - 168000) ?></a></td>
	<td><a href="statistic.php?date=<?php echo $date - 84000 ?>"><?php echo '&laquo; ' . date("Y-m-d", $date - 84000) ?></a></td>
	...
	<a href="statistic.php?date=<?php echo $date + 84000 ?>"><?php echo date("Y-m-d", $date + 84000) . ' &raquo;' ?></a>
	<?php endif; ?>
	</td>
	<td width="20%" align="right"> 
	<?php  if (($date + 168000) < time()): ?>
	<a href="statistic.php?date=<?php echo $date + 168000 ?>"><?php echo date("Y-m-d", $date + 168000) . ' &raquo;' ?></a>
	<?php endif; ?>
	</td>
	</tr>
</table>
...
<table class="lines"  cellspacing="0px">
	...
	<tr>
		<td align="center" colspan="3">Записей нет</td>
	</tr>
