...
Данное соглашение содержит перечень пунктов, в которых говориться о том, какими правами, в отношении, предостовляемого нами продукта, в частночти, CMS Fapos, Вы обладаете, а какими нет.
    ...
    4.Запрещаеться использование, не законно полученного продукта. Законно полученным, считаеться продукт, полученный с оффициального источника (ресурс http://fapos.net) или с этого сайта (http://home.develdo.com).
    ...
    8.Все права на продукт полностью и безраздельно принадлежат автору ©Andrey Brykin & CMS Fapos 2010-2011.
